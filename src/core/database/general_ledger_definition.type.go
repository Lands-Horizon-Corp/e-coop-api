...
type (
	GeneralLedgerDefinition struct {
		...
		BeginningBalanceOfTheYearCredit   float64 `gorm:"default:0"`
		BeginningBalanceOfTheYearDebit    float64 `gorm:"default:0"`
		BudgetForecastingOfTheYearPercent float64 `gorm:"default:0"`

		PastDue      string `gorm:"type:text"`
		InLitigation string `gorm:"type:text"`
	...
	GeneralLedgerDefinitionResponse struct {
		...
		BeginningBalanceOfTheYearCredit   float64           `json:"beginning_balance_of_the_year_credit"`
		BeginningBalanceOfTheYearDebit    float64           `json:"beginning_balance_of_the_year_debit"`
		BudgetForecastingOfTheYearPercent float64           `json:"budget_forecasting_of_the_year_percent"`
		PastDue                           string            `json:"past_due,omitempty"`
		InLitigation                      string            `json:"in_litigation,omitempty"`
	...
	GeneralLedgerDefinitionRequest struct {
		...
		BeginningBalanceOfTheYearCredit   float64           `json:"beginning_balance_of_the_year_credit,omitempty"`
		BeginningBalanceOfTheYearDebit    float64           `json:"beginning_balance_of_the_year_debit,omitempty"`
		BudgetForecastingOfTheYearPercent float64           `json:"budget_forecasting_of_the_year_percent,omitempty"`
		PastDue                           string            `json:"past_due,omitempty"`
		InLitigation                      string            `json:"in_litigation,omitempty"`
		GeneralLedgerDefinitionEntryID    *uuid.UUID        `json:"general_ledger_definition_entries_id,omitempty"`
	}

	PostingRequest struct {
		Type      string    `json:"type" validate:"required,oneof=post unpost"`
