...
type (
	AccountHistory struct {
		...
		IsIncludedInGeneralLedger      bool `gorm:"default:true" json:"is_included_in_general_ledger"`
		IsIncludedInFinancialStatement bool `gorm:"default:false" json:"is_included_in_financial_statement"`

		NetSurplusPositivePercentage1 float64 `gorm:"type:decimal" json:"net_surplus_positive_percentage_1"`
		NetSurplusPositivePercentage2 float64 `gorm:"type:decimal" json:"net_surplus_positive_percentage_2"`
		NetSurplusNegativePercentage1 float64 `gorm:"type:decimal" json:"net_surplus_negative_percentage_1"`
		NetSurplusNegativePercentage2 float64 `gorm:"type:decimal" json:"net_surplus_negative_percentage_2"`

		GLTotalDebit   float64 `gorm:"type:decimal" json:"gl_total_debit"`
		GLTotalCredit  float64 `gorm:"type:decimal" json:"gl_total_credit"`
		GLTotalBalance float64 `gorm:"type:decimal" json:"gl_total_balance"`

		FinancialStatementTitleID *uuid.UUID `gorm:"type:uuid" json:"financial_statement_title_id,omitempty"`
	}
