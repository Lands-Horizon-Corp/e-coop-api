...
type (
	OtherFundEntry struct {
		...
		OrganizationID uuid.UUID     `gorm:"type:uuid;not null;index:idx_organization_branch_other_fund_entry"`
		Organization   *Organization `gorm:"foreignKey:OrganizationID;constraint:OnDelete:CASCADE,OnUpdate:CASCADE;" json:"organization,omitempty"`
		BranchID       uuid.UUID     `gorm:"type:uuid;not null;index:idx_organization_branch_other_fund_entry"`
		...
		OtherFundID uuid.UUID  `gorm:"type:uuid;not null"`
		OtherFund   *OtherFund `gorm:"foreignKey:OtherFundID;constraint:OnDelete:RESTRICT,OnUpdate:CASCADE;" json:"other_fund,omitempty"`
	...
	OtherFundEntryResponse struct {
		...
		OtherFundID       uuid.UUID                `json:"other_fund_id"`
		OtherFund         *OtherFundResponse       `json:"other_fund,omitempty"`
