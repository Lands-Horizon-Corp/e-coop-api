...
type (
	...
	LoanTransactionEntry     struct {
		...
		MemberProfileID *uuid.UUID     `gorm:"type:uuid;index" json:"member_profile_id,omitempty"`
		MemberProfile   *MemberProfile `gorm:"foreignKey:MemberProfileID;constraint:OnDelete:SET NULL;" json:"member_profile,omitempty"`

		MemberLoanTransactionID *uuid.UUID       `gorm:"type:uuid;index" json:"member_loan_transaction_id"`
		MemberLoanTransaction   *LoanTransaction `gorm:"foreignKey:MemberLoanTransactionID;constraint:OnDelete:SET NULL;" json:"member_loan_transaction,omitempty"`
	}
	...
	LoanTransactionEntryResponse struct {
		...
		MemberLoanTransactionID *uuid.UUID               `json:"member_loan_transaction_id,omitempty"`
		MemberLoanTransaction   *LoanTransactionResponse `json:"member_loan_transaction,omitempty"`
	}
