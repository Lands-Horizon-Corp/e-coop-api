...
type (
	OtherFund struct {
		...
		OrganizationID uuid.UUID     `gorm:"type:uuid;not null;index:idx_organization_branch_other_fund"`
		Organization   *Organization `gorm:"foreignKey:OrganizationID;constraint:OnDelete:CASCADE,OnUpdate:CASCADE;" json:"organization,omitempty"`
		BranchID       uuid.UUID     `gorm:"type:uuid;not null;index:idx_organization_branch_other_fund"`
		...
		OtherFundTags    []*OtherFundTag   `gorm:"foreignKey:OtherFundID;constraint:OnDelete:CASCADE,OnUpdate:CASCADE;" json:"other_fund_tags,omitempty"`
		OtherFundEntries []*OtherFundEntry `gorm:"foreignKey:OtherFundID;constraint:OnDelete:CASCADE,OnUpdate:CASCADE;" json:"other_fund_entries,omitempty"`

		TotalDebit  float64 `gorm:"type:decimal" json:"total_debit"`
		TotalCredit float64 `gorm:"type:decimal" json:"total_credit"`
	}

	OtherFundResponse struct {
		...
		OtherFundTags    []*OtherFundTagResponse   `json:"other_fund_tags,omitempty"`
		OtherFundEntries []*OtherFundEntryResponse `json:"other_fund_entries,omitempty"`

		TotalDebit  float64 `json:"total_debit"`
		TotalCredit float64 `json:"total_credit"`
	}

	OtherFundRequest struct {
		...
		OtherFundEntries        []*OtherFundEntryRequest `json:"other_fund_entries,omitempty"`
		OtherFundEntriesDeleted uuid.UUIDs               `json:"other_fund_entries_deleted,omitempty"`
	}
	OtherFundPrintRequest struct {
		CashVoucherNumber string `json:"cash_voucher_number,omitempty"`
