...
type (
	BranchSetting struct {
		...
		RevolvingFundAccountID *uuid.UUID `gorm:"type:uuid" json:"revolving_fund_account_id,omitempty"`
		RevolvingFundAccount   *Account   `gorm:"foreignKey:RevolvingFundAccountID;constraint:OnDelete:SET NULL;" json:"revolving_fund_account,omitempty"`
	...
	BranchSettingsCurrencyRequest struct {
		...
		RevolvingFundAccountID       *uuid.UUID `json:"revolving_fund_account_id,omitempty"`
	...
	BranchSettingResponse struct {
		...
		RevolvingFundAccountID *uuid.UUID       `json:"revolving_fund_account_id,omitempty"`
		RevolvingFundAccount   *AccountResponse `json:"revolving_fund_account,omitempty"`
