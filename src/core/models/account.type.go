...
type (
	...
	Account struct {
		...
		IsIncludedInGeneralLedger      bool `gorm:"not null;default:true" json:"is_included_in_general_ledger"`
		IsIncludedInFinancialStatement bool `gorm:"not null;default:false" json:"is_included_in_financial_statement"`

		NetSurplusPositivePercentage1 float64 `gorm:"type:decimal(20,4);not null;default:0" json:"net_surplus_positive_percentage_1"`
		NetSurplusPositivePercentage2 float64 `gorm:"type:decimal(20,4);not null;default:0" json:"net_surplus_positive_percentage_2"`
		NetSurplusNegativePercentage1 float64 `gorm:"type:decimal(20,4);not null;default:0" json:"net_surplus_negative_percentage_1"`
		NetSurplusNegativePercentage2 float64 `gorm:"type:decimal(20,4);not null;default:0" json:"net_surplus_negative_percentage_2"`

		GLTotalDebit              float64                  `gorm:"type:decimal(20,4);not null;default:0" json:"gl_total_debit"`
		GLTotalCredit             float64                  `gorm:"type:decimal(20,4);not null;default:0" json:"gl_total_credit"`
		GLTotalBalance            float64                  `gorm:"type:decimal(20,4);not null;default:0" json:"gl_total_balance"`
		FinancialStatementTitleID *uuid.UUID               `gorm:"type:uuid" json:"financial_statement_title_id"`
		FinancialStatementTitle   *FinancialStatementTitle `gorm:"foreignKey:FinancialStatementTitleID;constraint:OnDelete:SET NULL;" json:"financial_statement_title,omitempty"`
	}
)
...
type AccountResponse struct {
	...
	IsIncludedInGeneralLedger      bool                             `json:"is_included_in_general_ledger"`
	IsIncludedInFinancialStatement bool                             `json:"is_included_in_financial_statement"`
	NetSurplusPositivePercentage1  float64                          `json:"net_surplus_positive_percentage_1"`
	NetSurplusPositivePercentage2  float64                          `json:"net_surplus_positive_percentage_2"`
	NetSurplusNegativePercentage1  float64                          `json:"net_surplus_negative_percentage_1"`
	NetSurplusNegativePercentage2  float64                          `json:"net_surplus_negative_percentage_2"`
	GLTotalDebit                   float64                          `json:"gl_total_debit"`
	GLTotalCredit                  float64                          `json:"gl_total_credit"`
	GLTotalBalance                 float64                          `json:"gl_total_balance"`
	FinancialStatementTitleID      *uuid.UUID                       `json:"financial_statement_title_id,omitempty"`
	FinancialStatementTitle        *FinancialStatementTitleResponse `json:"financial_statement_title,omitempty"`
}
...
type AccountQuickSearchResponse struct {
	ID                 uuid.UUID `json:"id"`
	Name               string    `json:"name"`
	Description        string    `json:"description"`
